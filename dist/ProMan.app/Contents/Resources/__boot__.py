...
_recipes_pil_prescript(['ImtImagePlugin', 'PcxImagePlugin', 'MpoImagePlugin', 'SgiImagePlugin', 'PsdImagePlugin', 'FliImagePlugin', 'BmpImagePlugin', 'IcnsImagePlugin', 'PpmImagePlugin', 'XbmImagePlugin', 'SunImagePlugin', 'FitsStubImagePlugin', 'CurImagePlugin', 'GribStubImagePlugin', 'PcdImagePlugin', 'BlpImagePlugin', 'EpsImagePlugin', 'ImImagePlugin', 'SpiderImagePlugin', 'MpegImagePlugin', 'GifImagePlugin', 'PalmImagePlugin', 'PdfImagePlugin', 'Jpeg2KImagePlugin', 'TgaImagePlugin', 'IcoImagePlugin', 'DcxImagePlugin', 'IptcImagePlugin', 'XVThumbImagePlugin', 'MspImagePlugin', 'McIdasImagePlugin', 'FtexImagePlugin', 'JpegImagePlugin', 'FpxImagePlugin', 'DdsImagePlugin', 'Hdf5StubImagePlugin', 'WebPImagePlugin', 'PngImagePlugin', 'XpmImagePlugin', 'MicImagePlugin', 'GbrImagePlugin', 'BufrStubImagePlugin', 'WmfImagePlugin', 'TiffImagePlugin', 'PixarImagePlugin'])
