...
_recipes_pil_prescript(['BufrStubImagePlugin', 'MicImagePlugin', 'PalmImagePlugin', 'DcxImagePlugin', 'ImtImagePlugin', 'WebPImagePlugin', 'MspImagePlugin', 'BlpImagePlugin', 'GbrImagePlugin', 'McIdasImagePlugin', 'ImImagePlugin', 'DdsImagePlugin', 'IcoImagePlugin', 'CurImagePlugin', 'PngImagePlugin', 'TiffImagePlugin', 'Hdf5StubImagePlugin', 'Jpeg2KImagePlugin', 'FitsStubImagePlugin', 'FpxImagePlugin', 'XbmImagePlugin', 'WmfImagePlugin', 'IcnsImagePlugin', 'PsdImagePlugin', 'BmpImagePlugin', 'XpmImagePlugin', 'XVThumbImagePlugin', 'SgiImagePlugin', 'PdfImagePlugin', 'FliImagePlugin', 'PcxImagePlugin', 'SpiderImagePlugin', 'EpsImagePlugin', 'SunImagePlugin', 'MpoImagePlugin', 'TgaImagePlugin', 'PpmImagePlugin', 'GribStubImagePlugin', 'PcdImagePlugin', 'FtexImagePlugin', 'MpegImagePlugin', 'JpegImagePlugin', 'GifImagePlugin', 'IptcImagePlugin', 'PixarImagePlugin'])
